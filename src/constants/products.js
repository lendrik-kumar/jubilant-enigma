...
export const products = [
  {
    ...
    description: "Defying gravity with every step. The X Lows Armstrong features premium materials and cutting-edge design for ultimate comfort and style.",
    features: [
  ...
  },
  {
    ...
    description: "Engineered for speed and endurance. The Air Runner Pro delivers exceptional performance with advanced cushioning technology.",
    features: [
  ...
  },
  {
    ...
    description: "Street-ready style meets all-day comfort. The Urban Street Elite is your perfect companion for city adventures.",
    features: [
      "Soft suede upper",
      "Memory foam insole",
      "Flexible outsole",
  ...
  },
  {
    ...
    description: "Conquer any terrain with confidence. The Trail Blazer X offers superior grip and protection for outdoor enthusiasts.",
    features: [
      "Waterproof membrane",
  ...
  },
  {
    ...
    description: "Move freely, train harder. The Flex Motion Lite adapts to your every movement for versatile workout performance.",
    features: [
      "Flexible knit upper",
  ...
  },
  {
    ...
    description: "Timeless design meets modern comfort. The Classic Heritage pays homage to iconic sneaker culture with contemporary updates.",
    features: [
  ...
  },
  {
    ...
    description: "Built for speed demons. The Speed Racer Max delivers explosive energy return for your fastest runs yet.",
    features: [
      "Carbon fiber plate",
  ...
  },
  {
    ...
    description: "Walk on clouds all day long. The Comfort Cloud features plush cushioning for unmatched everyday comfort.",
    features: [
  ...
  },
  {
    ...
    description: "Dominate the court with precision. The Basketball Elite Pro offers superior ankle support and responsive cushioning.",
    features: [
      "High-top design",
      "Zoom Air cushioning",
  ...
  },
  {
    ...
    description: "Built by skaters, for skaters. The Skate Legend delivers board feel and durability for your sessions.",
    features: [
  ...
  },
  {
    ...
    description: "Find your balance with ease. The Yoga Flow offers barefoot-like flexibility for studio and beyond.",
    features: [
      "Barefoot feel",
      "Split outsole",
      "Sock-like fit",
  ...
  },
  {
    ...
    images: ["/assets/shoes/shoe-6.avif", "/assets/shoes/shoe-7.avif"],
    thumbnail: "/assets/shoes/shoe-6.avif",
    description: "Perform on the course with confidence. The Golf Pro Tour delivers stability and comfort for 18 holes and beyond.",
    features: [
      "Waterproof leather",
      "Spiked traction",
      "Foam cushioning",
...
export const categories = [
  ...
  { id: "outdoor", name: "Outdoor", count: products.filter(p => p.category === "outdoor").length },
  { id: "skateboarding", name: "Skateboarding", count: products.filter(p => p.category === "skateboarding").length },
  { id: "golf", name: "Golf", count: products.filter(p => p.category === "golf").length },
];
