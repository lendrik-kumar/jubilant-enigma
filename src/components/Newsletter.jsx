    ...
    <section className="py-16 sm:py-24 bg-black">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-16 grid grid-cols-1 sm:grid-cols-3 gap-8 max-w-4xl mx-auto">
          {[
            { title: 'Early Access', description: 'Be first to shop new releases' },
            { title: 'Exclusive Deals', description: 'Members-only discounts & offers' },
            { title: 'Style Tips', description: 'Curated looks & trending styles' },
          ].map((benefit, index) => (
